...
private:
    ...
    static  vector <clsCurrency> _LoadCurrencysDataFromFile()
    {
        ...
        fstream MyFile;
        MyFile.open("D:\\OOP\Currencies.txt", ios::in);//read Mode
    ...
    static void _SaveCurrencyDataToFile(vector <clsCurrency> vCurrencys)
    {
        ...
        fstream MyFile;
        MyFile.open("D:\\OOP\Currencies.txt", ios::out);//overwrite
...
public:
    ...
    static   clsCurrency FindByCountry(string Country)
    {
        ...
        if (MyFile.is_open())
        {
            ...
            {
                clsCurrency Currency = _ConvertLinetoCurrencyObject(Line);
                if (clsString::UpperAllString(clsString::Trim( Currency.Country())) == Country)
                {
                    MyFile.close();
                    return Currency;
                }
    ...
    float ConvertToOtherCurrency(float Amount, clsCurrency Currency1)
    {
        ...
        return (float)(AmountInUsd * Currency1.Rate());
    }
};
